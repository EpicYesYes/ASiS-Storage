...
export const translations = {
  ms: {
    ...
    sync_desc: "Gunakan Tolak/Tarik untuk mengemas kini data antara peranti secara global.",
    sync_push: "Tolak Data (Hantar ke Awan)",
    sync_pull: "Tarik Data (Ambil dari Awan)",
